  ...
  return (
    ...
    {/*   <section className="-mt-32 bg-white px-4 pb-20 pt-4">
     ...
     {/*  <section className="px-4 pt-20 pb-48">
        ...
        Contact the Team Behind the Code
      </Typography>
      </div>
          <PageTitle section="" heading="Contact the Team Behind the Code">
            At SB Soluciones Ingeniería, our developers and technicians are passionate about technology and committed to helping your business thrive. 
            Whether it's building custom software or solving technical issues, we work with dedication, creativity, and a strong focus on your satisfaction.
          </PageTitle>
      ...
      <section className="relative bg-gray-300 py-24 px-4">
        <div className="container mx-auto">
          ...
          <PageTitle section="Contact Us" heading={<Typography variant="h2" color="blue-gray" className="my-3">
